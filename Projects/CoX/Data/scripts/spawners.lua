...
function spinPersists()
    ...
    --There are a number of "0" named persistent NPCs generated by walking the scenegraph
    --I suspect they may be store NPCs (magic store, natural store, etc.) but haven't
    --had the time to track down if this were
