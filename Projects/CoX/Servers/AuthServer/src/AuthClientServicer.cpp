...
int AuthClientService::open (void *p)
{
	...
	client = new AuthConnection_ServerSide; // this object will handle incoming data, interface with AuthServerProxy and also will post Message blocks on the queue
