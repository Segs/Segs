...
void ScriptingEngine::register_SpawnerTypes()
{
    ...
    {
        auto sg = this->mi->m_map_scenegraph->m_csNodes;
        uint sCount = sg.size();
        return sCount;
    };
    ...
    {
        auto sg = this->mi->m_map_scenegraph->m_persNodes;
        uint pCount = sg.size();
        return pCount;
    };
    ...
    {
        auto sg = this->mi->m_map_scenegraph->m_carNodes;
        uint cCount = sg.size();
        return cCount;
    };
    ...
    {
        auto sg = this->mi->m_map_scenegraph->m_npcNodes;
        uint nCount = sg.size();
        return nCount;
    };
