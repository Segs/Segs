...
//    EVENT_DECL(MapEventTypes, evServerSetClientState     ,118)
...
//    EVENT_DECL(MapEventTypes, evDeadNoGurney             ,152)
//    EVENT_DECL(MapEventTypes, evLevelUp                  ,160)
//    EVENT_DECL(MapEventTypes, evCSRBugReport             ,164)
    ...
    EVENT_DECL(MapEventTypes, evEmailMsgStatus            ,167)
...
// client -> server commands
    ...
    EVENT_DECL(MapEventTypes, evCombineRequest            ,240)
