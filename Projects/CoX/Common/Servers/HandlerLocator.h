...
class HandlerLocator
{
    ...
    static EventProcessor *m_supergroup_handler;
...
public:
    ...
    static void setSuperGroup_Handler(EventProcessor *h) { m_supergroup_handler=h; }
    static EventProcessor *getSuperGroup_Handler() { return m_supergroup_handler; }
