...
void Character::addStartingContact(const char *contact_name)
{
    ...
    startingContact.m_idx = 1939; // Npc Id
    ...
    startingContact.m_confidant_threshold = 2;
    startingContact.m_friend_threshold = 3;
    startingContact.m_complete_threshold = 4;
    startingContact.m_can_use_cell = true;
...
void Character::GetCharBuildInfo(BitStream &src)
{
    ...
    //Contact Test
    const char* test = "OfficerFlint";
    addStartingContact(test);
