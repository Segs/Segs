...
{
    event.Skip();
    std::cout<<"Event handler (LoginDialog::OnSetLogin) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    std::cout<<"Event handler (LoginDialog::OnSetPassword) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    std::cout<<"Event handler (LoginDialog::OnLogin) not implemented yet"<<std::endl; //notify the user that he hasn't implemented the event handler yet
}
